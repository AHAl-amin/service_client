...
//   const { data: getAllPropertiesList, refetch } = useGetAllPropertiesListQuery();
...
//   // Remove the redundant fetch call since useGetAllPropertiesListQuery already fetches the data
//   useEffect(() => {
...
//       // Optimistically update the property list by filtering out the deleted property
//       setPropertyList((prevList) => prevList.filter((property) => property.id !== id));

//       // Optionally, refetch the properties list to ensure consistency with the backend
//       refetch();
//     } catch (error) {
