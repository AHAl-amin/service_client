...
//             setFeatures((prev) => ({
//                 ...prev,
//                 customFeatures: [...prev.customFeatures, e.target.value],
//             }));
//             e.target.value = '';
//         }
//     };
...
//             <div className=''>
//                 <div className="mb-4">
//                     <label className="block text text-xl font-bold mb-2">Property Title</label>
//                     <input
//                         type="text"
...
//                     <label className="block text text-xl  font-bold mb-2">Land Size</label>
//                     <input
//                         type="text"
...
//                 <div className="mb-4 md:w-1/2">
//                     <label className="block  font-bold mb-2 text text-xl ">Property Type</label>
...
//                 <div className="mb-4">
//                     <label className="block text text-xl  font-bold mb-2">Description</label>
//                     <textarea
//                         className="w-full p-2 border rounded text-gray-800"
...
//                 </div>
//                 <div className="pt-5">
//                  <button className=' font-semibold flex gap-1 items-center bg px-4 py-2 rounded-xl cursor-pointer text-white'> <IoMdAdd className='size-5' />Add Custom feature</button>
//                 </div>
//             </div>
...
//             <Link to="/" className="bg text-white p-2 rounded-xl my-4 px-4 ">Next</Link>
//         </div>
//        </div>
...
const PropertyDetails = () => {
  ...
  return (
    <div>
      ...
      <div className="flex justify-end">
        <Link to="/seller_dashboard/media_images" className="bg-[#1C3988] text-white p-2 rounded-xl my-4 px-4">
          Next
        </Link>
      </div>
    </div>
