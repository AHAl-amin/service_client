            ...
            <div className=" bg-gray-50 p-4">
                ...
                p-2 bg-[#E8EBF3] border border-gray-300 rounded-md overflow-hidden">
                                        <button
                                            ...
                                            className={`flex-1 text-xl py-3 px-4  font-medium rounded ${activeTab === "basic" ? "bg text-white" : "  text-gray-700 "
                                                }`}
                                        >
                                            Basic Info
                                        </button>
                                        <button
                                            ...
                                            className={`flex-1 text-xl py-3 px-4  font-medium rounded ${activeTab === "advanced" ? "bg text-white" : " text-gray-700 "
                                                }`}
                                        >
                                            Advanced options
                                        </button>
