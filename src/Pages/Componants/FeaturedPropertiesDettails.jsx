...
function FeaturedPropertiesDetails() {
  ...
  // Set the initial main image to the property’s main image or fallback
  const displayedImage = mainImage || `${baseImageUrl}${property.main_image}`;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="relative">
              <img
                src={displayedImage} // Use mainImage or fallback
                alt={property.title}
              ...
              {thumbnailImages.map((img, index) => (
                <div key={index} className="relative">
                  <img
                    ...
                    onClick={() => setMainImage(img)} // Set clicked thumbnail as the main image
                  />
                </div>
              ))}
          ...
          <form onSubmit={handleContactSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border ${errors.fullname ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 text-gray-800 focus:ring-[#1C3988] focus:border-transparent`}
                  required
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border ${errors.email ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 text-gray-800 focus:ring-[#1C3988] focus:border-transparent`}
                  required
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border ${errors.country ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 text-gray-800 focus:ring-[#1C3988] focus:border-transparent`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border ${errors.phone ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 text-gray-800 focus:ring-[#1C3988] focus:border-transparent`}
                />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={4}
                className={`w-full px-3 py-2 border ${errors.message ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 text-gray-800 focus:ring-[#1C3988] focus:border-transparent resize-none`}
              />
            ...
            <div className="flex space-x-4">
              <button
                type="submit"
                disabled={isSubmitting}
                className={`bg-[#1C3988] hover:bg-[#163070] text-white px-6 py-2 rounded font-medium transition-colors ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""}`}
              >
